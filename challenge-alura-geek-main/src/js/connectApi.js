...
async function listProducts() {
    try {
        const connection = await fetch("https://challenge-alurageek-api.vercel.app/produtos");
...
async function deleteProduct(productId) {
    try {
        const connection = await fetch(`https://challenge-alurageek-api.vercel.app/produtos/${productId}`, {
            method: "DELETE",
        });
